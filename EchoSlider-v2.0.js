...
;(function() {
    ...
    /**
     * Decodifica una stringa che può contenere HTML (entità e tag),
     * restituendo l'HTML pronto per essere inserito via innerHTML.
     */
    function echoDecodeHtml(str) {
    ...
    function echoBuildAllSlides() {
        ...
        for (var i = 0; i < config.numTopics; i++) {
            if (i < echoTopicsData.length) {
                ...
                // Il contenuto del link interpreta correttamente tag e entità HTML
